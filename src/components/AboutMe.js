    ...
    <div className="about-me">
      <h1>
        ...
        <div className="about-me-skills">
          ...
          <div>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-plain-wordmark.svg'/>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original-wordmark.svg'/>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-plain-wordmark.svg'/>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-plain.svg'/>
            ...
            <div>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-plain-wordmark.svg'/>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-plain-wordmark.svg'/>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-plain-wordmark.svg'/>
            ...
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original-wordmark.svg'/>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/django/django-plain-wordmark.svg'/>
            <img style = {{width: '150px'}}src='https://cdn.jsdelivr.net/gh/devicons/devicon/icons/sqlite/sqlite-plain-wordmark.svg'/>
